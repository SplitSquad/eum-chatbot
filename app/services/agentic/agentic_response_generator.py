...
class AgenticResponseGenerator:
    ...
    async def generate_response(self, query: str, agentic_type: AgenticType) -> Dict[str, Any]:
        """응답을 생성합니다."""
        try:
            if agentic_type == AgenticType.GENERAL:
                ...
                return await self._generate_calendar_response(query)
    ...
    async def _generate_calendar_response(self, query: str) -> Dict[str, Any]:
        """캘린더 관리 응답을 생성합니다."""
        # TODO: 캘린더 관리 기능 구현
        return await self._generate_general_response(query)
